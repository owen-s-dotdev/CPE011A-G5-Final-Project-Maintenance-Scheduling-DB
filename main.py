...
class GenericTableTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.btn_refresh.setProperty("class", "neutral")
...
if __name__ == "__main__":
    import traceback
    from ui_layer import apply_global_style, MainUIWrapper
    ...
    try:
        ...
        wrapped_ui = MainUIWrapper(main_window)

        wrapped_ui.resize(1200, 800)
        wrapped_ui.show()
